...
Last update on 28 November 2025. As of version 0.1.3, annual data is up to the financial year 2024-25 and monthly data is up to October 2025.
...
metro_lga_plot =
  ...
  geom_vline(
<<<<<<< HEAD
    xintercept = ymd("2025-9-1"), 
    linetype = 2,
    colour = bv.charcoal)+
  geom_text(
    data = tibble(
      "data_month" = ymd("2025-9-5"),
      "value" = 1e6,
      "data_label" = "Trial\ncommenced"
    ),
    aes(x = data_month,
...
suppressWarnings(plot(metro_lga_plot))
...
suppressWarnings(plot(regional_lga_plot))
