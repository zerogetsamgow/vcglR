...
ggplot() +
  ...
  coord_cartesian(xlim = ymd("2023-8-1","2026-6-1"), ylim = c(0,16e6)) +
...
This means comparisons for Ballarat will need to be made against similar regional centres rather than neighbouring LGAs. For example.
...
ggplot() +
  ...
  coord_cartesian(xlim = ymd("2023-8-1","2026-6-1"), ylim = c(0,8e6)) +
