...
Last update ond `r format.Date(Sys.Date(),"%d %B %Y")`. Annual data is up to the `r fy::date2fy(Sys.Date()) |> fy::prev_fy()` financial year and monthly data is up to `r (lubridate::round_date(Sys.Date(), unit = "month") - lubridate::days(1) - lubridate::dmonths(1)) |> format.Date("%B %Y")`.
