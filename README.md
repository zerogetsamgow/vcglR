...
#> Rows: 18,012
#> Columns: 9
#> $ venue_name     <chr> "Geelong Football Club", "Geelong Footba…
#> $ venue_type     <fct> Club, Club, Club, Club, Club, Club, Club…
#> $ lga_name       <chr> "Greater Geelong", "Greater Geelong", "M…
#> $ financial_year <fy> 2008-09, 2008-09, 2008-09, 2008-09, 2008-…
#> $ fy_date        <date> 2009-06-30, 2009-06-30, 2009-06-30, 200…
#> $ measure_type   <fct> Expenditure, EGM, Expenditure, EGM, Expe…
#> $ value          <dbl> 4416533, 100, 2206156, 34, 3336512, 83, …
#> $ lat            <dbl> -38.158, -38.158, -34.305, -34.305, -37.…
#> $ long           <dbl> 144.35, 144.35, 142.19, 142.19, 145.04, …
```
...
#> Rows: 8,301
#> Columns: 5
#> $ lga_name       <chr> "Alpine", "Alpine", "Alpine", "Alpine", …
#> $ financial_year <date> 2019-06-30, 2019-06-30, 2019-06-30, 201…
#> $ data_month     <date> 2018-07-31, 2018-08-31, 2018-09-30, 201…
#> $ measure_type   <chr> "Expenditure", "Expenditure", "Expenditu…
#> $ value          <dbl> 224281, 156538, 202779, 173965, 179321, …
```
...
Last update on 28 July 2026. Annual data is up to the 2025-26 financial
year and monthly data is up to June 2026.
...
<img src="man/figures/README-make_melb_map-1.png" alt="" width="100%" />
...
<img src="man/figures/README-lga_expend_plot-1.png" alt="" width="100%" />
...
<img src="man/figures/README-make_ballarat_map-1.png" alt="" width="100%" />

This means comparisons for Ballarat need to be made against similar
regional centres rather than neighbouring LGAs. For example.

<img src="man/figures/README-regional_expend_plot-1.png" alt="" width="100%" />

As venue data in the package is geocoded it supports analysis using
other geographies like Statistical Areas.

<img src="man/figures/README-make_melb_sa3_map-1.png" alt="" width="100%" />

<img src="man/figures/README-use_pop-1.png" alt="" width="100%" />
